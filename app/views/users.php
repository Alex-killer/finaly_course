<?php $this->layout('layout', ['title' => 'Юзеры']); ?>
    ...
    <body class="mod-bg-1 mod-nav-link">
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <?php if ($userAdmin): ?>
                    <a class="btn btn-success" href="/add_user">Добавить</a>
                    <?php endif;?>
            ...
            <div class="row" id="js-contacts">
                <?php foreach ($userPaginate as $user):?>
                <div class="col-xl-4">
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <span class="status <?= $status?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('/upload/<?= $user['image']?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <?php if($userId == $user['id'] || $userAdmin): ?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        Редактировать</a>
                                        <a class="dropdown-item" href="/edit_password/<?= $user['id']?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="/update_status/<?= $user['id']?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="/update_avatar/<?= $user['id']?>"">
