...
<head>
    ...
    <link rel="stylesheet" media="screen, print" href="/resources/css/page-login-alt.css">
</head>
<body>
    ...
    <video poster="/resources/img/backgrounds/clouds.png" id="bgvid" playsinline autoplay muted loop>
        <source src="/resources/media/video/cc.webm" type="video/webm">
        <source src="/resources/media/video/cc.mp4" type="video/mp4">
    </video>
    <script src="esources/js/vendors.bundle.js"></script>
</body>
